...
GetAllActivities().then(data => {
  ...
  ids.value =index[ActivityAction.DownloadPdf] ? Object.keys(index[ActivityAction.DownloadPdf])
      .sort((a, b) => index[ActivityAction.DownloadPdf][b].length - index[ActivityAction.DownloadPdf][a].length)
